// Declaramos la clase
function Proceso(id, nombre, tiempoEstimado, operacion, tiemporestante){
    ...
    this.ToString = function(){
        return `Datos del Proceso: ${this.id}, ${this.nombre}, ${this.tiempoEstimado}, ${this.operacion} = ${this.tiemporestante}, ${this.tiemporestante}`;
    }
